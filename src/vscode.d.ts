...
declare module 'vscode' {
	...
	export interface DecorationOptions {
		 ...
		 */
		hoverMessage?: Array<MarkdownString | MarkedString> | MarkdownString | MarkedString;
	...
	export interface DocumentPasteEditProvider<T extends DocumentPasteEdit = DocumentPasteEdit> {
		 ...
		 */
		prepareDocumentPaste?(document: TextDocument, ranges: readonly Range[], dataTransfer: DataTransfer, token: CancellationToken): Thenable<void> | void;
	 ...
	 */
	export type DocumentSelector = DocumentFilter | ReadonlyArray<DocumentFilter | string> | string;
	...
	export interface ExtensionContext {
		 ...
		 *  a uri.
		 */
		readonly storageUri: undefined | Uri;
	 ...
	 */
	export type GlobPattern = RelativePattern | string;
	 ...
	 */
	export type IconPath = ThemeIcon | Uri | {
		/**
	 ...
	 */
	export type InlineValue = InlineValueEvaluatableExpression | InlineValueText | InlineValueVariableLookup;
	...
	export interface InputBoxOptions {
		 ...
		 */
		validateInput?(value: string): InputBoxValidationMessage | null | string | Thenable<InputBoxValidationMessage | null | string | undefined> |
			undefined;
	 ...
	 * ```
	 */
	export type ProviderResult<T> = null | T | Thenable<null | T | undefined> | undefined;
	...
	export interface Terminal {
		 ...
		 */
		readonly creationOptions: Readonly<ExtensionTerminalOptions | TerminalOptions>;
	...
	export interface TextEditor {
		 ...
		 */
		setDecorations(decorationType: TextEditorDecorationType, rangesOrOptions: readonly DecorationOptions[] | readonly Range[]): void;
		 ...
		 */
		readonly viewColumn: undefined | ViewColumn;
	...
	export interface WorkspaceConfiguration {
		 ...
		 */
		update(section: string, value: any, configurationTarget?: boolean | ConfigurationTarget | null, overrideInLanguage?: boolean): Thenable<void>;
	}
	...
	export class CompletionItem {
		 ...
		 * this completion.
		 */
		label: CompletionItemLabel | string;
		 ...
		 */
		constructor(label: CompletionItemLabel | string, kind?: CompletionItemKind);
	}
	...
	export class DocumentDropEdit {
		 ...
		 */
		constructor(insertText: SnippetString | string, title?: string, kind?: DocumentDropOrPasteEditKind);
	}
	...
	export class Hover {
		 ...
		 */
		constructor(contents: Array<MarkdownString | MarkedString> | MarkdownString | MarkedString, range?: Range);
	}
	...
	export class InlayHint {
		 ...
		 */
		label: InlayHintLabelPart[] | string;
		 ...
		 */
		constructor(position: Position, label: InlayHintLabelPart[] | string, kind?: InlayHintKind);
	}
	...
	export class InlineCompletionItem {
		 ...
		 */
		constructor(insertText: SnippetString | string, range?: Range, command?: Command);
	}
	...
	export class Location {
		 ...
		 */
		constructor(uri: Uri, rangeOrPosition: Position | Range);
	}
	...
	export class ParameterInformation {
		 ...
		 */
		constructor(label: [number, number] | string, documentation?: MarkdownString | string);
	}
	...
	export class ShellExecution {
		 ...
		 */
		args: Array<ShellQuotedString | string> | undefined;

		/**
		 * The shell command. Is `undefined` if created with a full command line.
		 */
		command: ShellQuotedString | string | undefined;
		 ...
		 * @param options Optional options for the started the shell.
		 */
		constructor(command: ShellQuotedString | string, args: Array<ShellQuotedString | string>, options?: ShellExecutionOptions);
	}
	...
	export class SignatureInformation {
		 ...
		 * @param documentation A doc string.
		 */
		constructor(label: string, documentation?: MarkdownString | string);
	}
	...
	export class SnippetString {
		 ...
		 * @returns This snippet string.
		 */
		appendPlaceholder(value: ((snippet: SnippetString) => any) | string, number?: number): SnippetString;
		 ...
		 * @returns This snippet string.
		 */
		appendVariable(name: string, defaultValue: ((snippet: SnippetString) => any) | string): SnippetString;
	}
	...
	export class Task {
		 ...
		 */
		execution?: CustomExecution | ProcessExecution | ShellExecution;
		 ...
		 * The task's scope.
		 */
		readonly scope: TaskScope.Global | TaskScope.Workspace | undefined | WorkspaceFolder;
		 ...
		 */
		constructor(taskDefinition: TaskDefinition, scope: TaskScope.Global | TaskScope.Workspace | WorkspaceFolder, name: string, source: string, execution?: CustomExecution | ProcessExecution | ShellExecution, problemMatchers?: string | string[]);
	...
	export class TerminalProfile {
		 ...
		 */
		constructor(options: ExtensionTerminalOptions | TerminalOptions);
	}
	...
	export class WorkspaceEdit {
		...
		createFile(uri: Uri, options?: {
			 ...
			 */
			readonly contents?: DataTransferFile | Uint8Array;
			/**
		 ...
		 */
		set(uri: Uri, edits: ReadonlyArray<SnippetTextEdit | TextEdit>): void;
		/**
		 ...
		 * @param edits An array of edits.
		 */
		set(uri: Uri, edits: ReadonlyArray<[SnippetTextEdit | TextEdit, undefined | WorkspaceEditEntryMetadata]>): void;
		/**
		 ...
		 * @param edits An array of edits.
		 */
		set(uri: Uri, edits: ReadonlyArray<[NotebookEdit, undefined | WorkspaceEditEntryMetadata]>): void;
	}
	...
	export interface FileSystemProvider {
		 ...
		 * @throws {@linkcode FileSystemError.NoPermissions NoPermissions} when permissions aren't sufficient.
		 */
		createDirectory(uri: Uri): Thenable<void> | void;
		 ...
		 * @throws {@linkcode FileSystemError.FileNotFound FileNotFound} when `uri` doesn't exist.
		 */
		readFile(uri: Uri): Thenable<Uint8Array> | Uint8Array;
	...
	export namespace window {
		...
		export function createWebviewPanel(viewType: string, title: string, showOptions: ViewColumn | {
			 ...
			 */
			readonly viewColumn: ViewColumn;
		}, options?: WebviewOptions & WebviewPanelOptions): WebviewPanel;
		 ...
		 */
		export function registerCustomEditorProvider(viewType: string, provider: CustomEditorProvider | CustomReadonlyEditorProvider | CustomTextEditorProvider, options?: {
			/**
		 ...
		 */
		export function showOpenDialog(options?: OpenDialogOptions): Thenable<undefined | Uri[]>;
		 ...
		 */
		export function showSaveDialog(options?: SaveDialogOptions): Thenable<undefined | Uri>;
		 ...
		 */
		export function showWorkspaceFolderPick(options?: WorkspaceFolderPickOptions): Thenable<undefined | WorkspaceFolder>;
	...
	export interface EnvironmentVariableCollection extends Iterable<[variable: string, mutator: EnvironmentVariableMutator]> {
		 ...
		 * changes in the UI.
		 */
		description: MarkdownString | string | undefined;
	...
	export interface InputBox extends QuickInput {
		 ...
		 */
		validationMessage: InputBoxValidationMessage | string | undefined;
	...
	export interface TreeDataProvider<T> {
		 ...
		 */
		getTreeItem(element: T): Thenable<TreeItem> | TreeItem;
		 ...
		 */
		onDidChangeTreeData?: Event<null | T | T[] | undefined | void>;
	...
	export namespace workspace {
		 ...
		 */
		export const workspaceFile: undefined | Uri;
		 ...
		 */
		export function getWorkspaceFolder(uri: Uri): undefined | WorkspaceFolder;
		 ...
		 */
		export function save(uri: Uri): Thenable<undefined | Uri>;
		 ...
		 */
		export function saveAs(uri: Uri): Thenable<undefined | Uri>;
		 ...
		 */
		export function updateWorkspaceFolders(start: number, deleteCount: null | number | undefined, ...workspaceFoldersToAdd: {
			/**
	 ...
	 */
	export type ConfigurationScope = TextDocument | Uri | WorkspaceFolder | {
		/**
	...
	export interface NotebookController {
		 ...
		 */
		executeHandler: (cells: NotebookCell[], notebook: NotebookDocument, controller: NotebookController) => Thenable<void> | void;
		 ...
		 */
		interruptHandler?: (notebook: NotebookDocument) => Thenable<void> | void;
	...
	export namespace notebooks {
		 ...
		 */
		export function createNotebookController(id: string, notebookType: string, label: string, handler?: (cells: NotebookCell[], notebook: NotebookDocument, controller: NotebookController) => Thenable<void> | void): NotebookController;
	...
	export interface SourceControlResourceThemableDecorations {
		 ...
		 * {@link SourceControlResourceState source control resource state}.
		 */
		readonly iconPath?: string | ThemeIcon | Uri;
	}
	 ...
	 */
	export type DebugAdapterDescriptor = DebugAdapterExecutable | DebugAdapterInlineImplementation | DebugAdapterNamedPipeServer | DebugAdapterServer;
	...
	export interface DebugConfigurationProvider {
		 ...
		 */
		provideDebugConfigurations?(folder: undefined | WorkspaceFolder, token?: CancellationToken): ProviderResult<DebugConfiguration[]>;
		 ...
		 */
		resolveDebugConfiguration?(folder: undefined | WorkspaceFolder, debugConfiguration: DebugConfiguration, token?: CancellationToken): ProviderResult<DebugConfiguration>;
		 ...
		 * @returns The resolved debug configuration or undefined or null.
		 */
		resolveDebugConfigurationWithSubstitutedVariables?(folder: undefined | WorkspaceFolder, debugConfiguration: DebugConfiguration, token?: CancellationToken): ProviderResult<DebugConfiguration>;
	}
	...
	export interface DebugSession {
		 ...
		 */
		readonly workspaceFolder: undefined | WorkspaceFolder;
	}
	...
	export namespace debug {
		 ...
		 */
		export const activeStackItem: DebugStackFrame | DebugThread | undefined;

		/**
		 * An event which fires when the {@link debug.activeStackItem} has changed.
		 */
		export const onDidChangeActiveStackItem: Event<DebugStackFrame | DebugThread | undefined>;
		 ...
		 */
		export function startDebugging(folder: undefined | WorkspaceFolder, nameOrConfiguration: DebugConfiguration | string, parentSessionOrOptions?: DebugSession | DebugSessionOptions): Thenable<boolean>;
	...
	export interface CommentingRangeProvider {
		 ...
		 */
		provideCommentingRanges(document: TextDocument, token: CancellationToken): ProviderResult<CommentingRanges | Range[]>;
	}
	...
	export interface AuthenticationGetSessionOptions {
		 ...
		 */
		createIfNone?: AuthenticationGetSessionPresentationOptions | boolean;
		 ...
		 */
		forceNewSession?: AuthenticationGetSessionPresentationOptions | boolean  ;
	...
	export namespace authentication {
		 ...
		 */
		export function getSession(providerId: string, scopes: readonly string[], options: AuthenticationGetSessionOptions & { /** */createIfNone: AuthenticationGetSessionPresentationOptions | true }): Thenable<AuthenticationSession>;
		 ...
		 * @returns A thenable that resolves to an authentication session
		 */
		export function getSession(providerId: string, scopes: readonly string[], options: AuthenticationGetSessionOptions & { /** literal-type defines return type */forceNewSession: AuthenticationGetSessionPresentationOptions | true   }): Thenable<AuthenticationSession>;
	...
	export namespace l10n {
		 ...
		 */
		export function t(message: string, ...args: Array<boolean | number | string>): string;
		...
		export function t(options: {
			 ...
			 */
			args?: Array<boolean | number | string> | Record<string, any>;
			/**
		 ...
		 */
		export const bundle: undefined | { [key: string]: string };
		/**
		 * The URI of the localization bundle that has been loaded for the extension.
		 * It's undefined if no bundle has been loaded. The bundle is typically not loaded if
		 * there was no bundle found or when we are running with the default language.
		 */
		export const uri: undefined | Uri;
	}
	...
	export interface ChatPromptReference {
		 ...
		 */
		readonly value: Location | string | unknown | Uri;
	}
	 ...
	 */
	export type ChatResponsePart = ChatResponseAnchorPart | ChatResponseCommandButtonPart | ChatResponseFileTreePart
		| ChatResponseMarkdownPart | ChatResponseProgressPart | ChatResponseReferencePart;
	...
	export interface ChatResponseStream {
		 ...
		 */
		anchor(value: Location | Uri, title?: string): void;
		 ...
		 */
		markdown(value: MarkdownString | string): void;
		 ...
		 */
		reference(value: Location | Uri, iconPath?: IconPath): void;
	}
	 ...
	 */
	export type FileCoverageDetail = DeclarationCoverage | StatementCoverage;
	...
	export interface Tab {
		 ...
		 */
		readonly input: TabInputCustom | TabInputNotebook | TabInputNotebookDiff | TabInputTerminal | TabInputText | TabInputTextDiff | TabInputWebview | unknown;
	...
	export interface TabGroups {
		 ...
		 */
		close(tab: readonly Tab[] | Tab, preserveFocus?: boolean): Thenable<boolean>;
		 ...
		 */
		close(tabGroup: readonly TabGroup[] | TabGroup, preserveFocus?: boolean): Thenable<boolean>;
	...
	export interface TestController {
		 ...
		 */
		invalidateTestResults(items?: readonly TestItem[] | TestItem): void;
	...
	export interface TestItem {
		 ...
		 */
		error: MarkdownString | string | undefined;
	...
	export interface TestRun {
		 ...
		 */
		errored(test: TestItem, message: readonly TestMessage[] | TestMessage, duration?: number): void;
		 ...
		 * @param duration How long the test took to execute, in milliseconds.
		 */
		failed(test: TestItem, message: readonly TestMessage[] | TestMessage, duration?: number): void;
	...
	export class BranchCoverage {
		 ...
		 */
		constructor(executed: boolean | number, location?: Position | Range, label?: string);
	}
	...
	export class ChatResponseAnchorPart {
		 ...
		 * @param title An optional title that is rendered with value.
		 */
		constructor(value: Location | Uri, title?: string);
	}
	...
	export class ChatResponseMarkdownPart {
		 ...
		 * @param value A markdown string or a string that should be interpreted as markdown. The boolean form of {@link MarkdownString.isTrusted} is NOT supported.
		 */
		constructor(value: MarkdownString | string);
	}
	...
	export class ChatResponseReferencePart {
		 ...
		 * @param iconPath Icon for the reference shown in UI
		 */
		constructor(value: Location | Uri, iconPath?: IconPath);
	}
	...
	export class ChatResponseTurn {
		 ...
		 */
		readonly response: ReadonlyArray<ChatResponseAnchorPart | ChatResponseCommandButtonPart | ChatResponseFileTreePart | ChatResponseMarkdownPart>;
		 ...
		 * @hidden
		 */
		private constructor(response: ReadonlyArray<ChatResponseAnchorPart | ChatResponseCommandButtonPart | ChatResponseFileTreePart | ChatResponseMarkdownPart>, result: ChatResult, participant: string);
	}
	...
	export class DeclarationCoverage {
		 ...
		 */
		constructor(name: string, executed: boolean | number, location: Position | Range);
	}
	...
	export class StatementCoverage {
		 ...
		 */
		constructor(executed: boolean | number, location: Position | Range, branches?: BranchCoverage[]);
	}
	...
	export class TestMessage {
		 ...
		 */
		constructor(message: MarkdownString | string);
		 ...
		 */
		static diff(message: MarkdownString | string, expected: string, actual: string): TestMessage;
	}
	...
	export interface LanguageModelChat {
		 ...
		 */
		countTokens(text: LanguageModelChatMessage | string, token?: CancellationToken): Thenable<number>;
	...
	export interface LanguageModelChatProvider<T extends LanguageModelChatInformation = LanguageModelChatInformation> {
		 ...
		 */
		provideTokenCount(model: T, text: LanguageModelChatRequestMessage | string, token: CancellationToken): Thenable<number>;
	}
	 ...
	 */
	export type LanguageModelInputPart = LanguageModelTextPart | LanguageModelToolCallPart | LanguageModelToolResultPart;
	...
	export class LanguageModelChatMessage {
		 ...
		 */
		constructor(role: LanguageModelChatMessageRole, content: Array<LanguageModelInputPart> | string, name?: string);
		 ...
		 * @param name The optional name of a user for the message.
		 */
		static Assistant(content: Array<LanguageModelTextPart | LanguageModelToolCallPart> | string, name?: string): LanguageModelChatMessage;
		 ...
		 * @param name The optional name of a user for the message.
		 */
		static User(content: Array<LanguageModelTextPart | LanguageModelToolResultPart> | string, name?: string): LanguageModelChatMessage;
	}
	...
	export class McpStdioServerDefinition {
		 ...
		 */
		env: Record<string, null | number | string>;
		 ...
		 */
		constructor(label: string, command: string, args?: string[], env?: Record<string, null | number | string>, version?: string);
	}
	...
	export interface PreparedToolInvocation {
		 ...
		 */
		invocationMessage?: MarkdownString | string;
	}
	...
	export class LanguageModelToolResult {
		 ...
		 */
		content: Array<LanguageModelPromptTsxPart | LanguageModelTextPart | unknown>;

		/**
		 * Create a LanguageModelToolResult
		 * @param content A list of tool result content parts
		 */
		constructor(content: Array<LanguageModelPromptTsxPart | LanguageModelTextPart>);
	}
	...
	export class LanguageModelToolResultPart {
		 ...
		 */
		constructor(callId: string, content: Array<LanguageModelPromptTsxPart | LanguageModelTextPart | unknown>);
	}
}
